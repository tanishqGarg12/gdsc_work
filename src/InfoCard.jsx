...
const InfoCard = () => {
    ...
    return (
        <div className={`max-w-screen-xl mx-auto my-10 p-8 rounded-lg shadow-lg transition-colors duration-300 ${darkMode ? 'bg-gray-800 text-gray-200' : 'bg-white text-gray-800'}`}>
            <h3 className="text-4xl font-bold mb-6 text-center">What We Do:</h3>
            <ul className="list-disc list-inside mb-6 space-y-3">
                <li className="flex items-center text-lg">
                    <FaHandsHelping className="text-blue-500 mr-3" size={24} /> Hands-on coding workshops (Beginner and Experienced)
                </li>
                <li className="flex items-center text-lg">
                    <FaProjectDiagram className="text-blue-500 mr-3" size={24} /> Build side projects
                </li>
                <li className="flex items-center text-lg">
            ...
            <p className="mt-4 text-center text-lg">
                Email us at <a href="mailto:cse.dsc@chitkara.edu.in" className="text-blue-500 underline">cse.dsc@chitkara.edu.in</a> for questions and more information!
            </p>
        </div>
    );
};
