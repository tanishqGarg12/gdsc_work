...
const Footer = () => {
    ...
    return (
        <footer className={`${darkMode ? 'bg-gray-900 text-gray-200 border-t border-gray-700 shadow-lg' : 'bg-gray-100 text-gray-800'} py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-16`}>
